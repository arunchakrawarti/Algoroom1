    ...
    <section className="px-4 sm:px-8 lg:px-16 py-10">
      <div className="max-w-7xl mx-auto mt-20 flex flex-col lg:flex-row items-start gap-10">
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-amber-400 rounded-tr-4xl p-4 rounded-md hover:bg-red-500 hover:text-white transition-colors">
          ...
          <div className="bg-amber-400 p-4 rounded-tr-4xl rounded-md hover:bg-red-500 hover:text-white transition-colors">
